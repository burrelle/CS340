...
('18', 'Landon', 'Collins', '24', (SELECT teamID FROM teams WHERE mascot = 'Giants'), (SELECT positionGroupID FROM positionGroup WHERE positionGroup = 'Defense'), (SELECT positionID FROM positions WHERE position = 'DB')),
...
('52', 'Alex', 'Ogletree', '26', (SELECT teamID FROM teams WHERE mascot = 'Rams'), (SELECT positionGroupID FROM positionGroup WHERE positionGroup = 'Defense'), (SELECT positionID FROM positions WHERE position = 'LB')),
...
('50', 'Telvin', 'Smith', '26', (SELECT teamID FROM teams WHERE mascot = 'Jaguars'), (SELECT positionGroupID FROM positionGroup WHERE positionGroup = 'Defense'), (SELECT positionID FROM positions WHERE position = 'LB')),
('50', 'Bobby', 'Wagner', '27', (SELECT teamID FROM teams WHERE mascot = 'Seahawks'), (SELECT positionGroupID FROM positionGroup WHERE positionGroup = 'Defense'), (SELECT positionID FROM positions WHERE position = 'LB')),
